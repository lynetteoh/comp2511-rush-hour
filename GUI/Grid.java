...
public class Grid {
	...
	EventHandler<MouseEvent> rectOnMouseDraggedEventHandler =
		...
		public void handle(MouseEvent t) {
			...
			if (block.getOrientation().equals("HORIZONTAL")){
				...
				else if ((block.getX() + newTranslateX + block.getWidth()) > gridLength){
				...
				else if ((block.getY() + newTranslateY + block.getHeight()) > gridLength){
					System.out.println(ANSI_GREEN + "..................." + ANSI_RESET);
					newTranslateY -= (block.getY() + newTranslateY + block.getHeight()) - gridLength;
				}

				// if ((newTranslateY + block.getHeight()) < 0){
				// 	System.out.println(ANSI_BLUE + "..................." + ANSI_RESET);
				// 	//newTranslateY = block.getHeight();
				// }
	...
	// private void moveHorizontal(MouseEvent t){
	// 	double offsetX = t.getSceneX() - orgSceneX;
	// 	double newTranslateX = orgTranslateX + offsetX;
