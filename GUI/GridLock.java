...
public class GridLock extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		try {
			...
			root.getChildren().addAll(grid.createSprite(0,0,100,50));
			root.getChildren().addAll(grid.createSprite(200,50,100,50));
			root.getChildren().addAll(grid.createSprite(50,200,100,50)); // this and above are horizontal blocks
						// //System.out.println("----");
			root.getChildren().addAll(grid.createSprite(200,100,50,100)); // this and below are vertical blocks
